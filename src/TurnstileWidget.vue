...
const props = withDefaults(defineProps<TurnstileProps>(), {
  ...
  logLevel: import.meta.env.VITE_TURNSTILE_LOGLEVEL ?? 'info',
  theme: import.meta.env.VITE_TURNSTILE_THEME,
  language: import.meta.env.VITE_TURNSTILE_LANGUAGE,
  tabindex: import.meta.env.VITE_TURNSTILE_TABINDEX,
  size: import.meta.env.VITE_TURNSTILE_SIZE,
  retry: import.meta.env.VITE_TURNSTILE_RETRY,
  retryInterval: import.meta.env.VITE_TURNSTILE_RETRY_INTERVAL,
  refreshExpired: import.meta.env.VITE_TURNSTILE_REFRESH_EXPIRED,
  refreshTimeout: import.meta.env.VITE_TURNSTILE_REFRESH_TIMEOUT,
  appearance: import.meta.env.VITE_TURNSTILE_APPEARANCE,
  feedbackEnabled: import.meta.env.VITE_TURNSTILE_FEEDBACK_ENABLED,
});
